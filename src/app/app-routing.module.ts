...
export const routes: Routes = [
  ...
  { path: 'pagos', component: PagosListComponent }, // Listado de pagos
  { path: 'pagos/create', component: PagosCreateComponent }, // Crear nuevo cliente
  { path: 'pagos/:id', component: PagosDetailComponent }, // Detalle de cliente
  { path: 'pagos/:id/edit', component: PagosEditComponent }, // Editar cliente
  */
